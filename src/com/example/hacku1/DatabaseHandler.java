...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "silentlocs.db3";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_PLACES_TABLE = "CREATE TABLE " + TABLE_PLACES + "("
                ...
                + KEY_LAT + " TEXT," + KEY_LONG + " TEXT," + KEY_RAD+" TEXT"+")";
    ...
    // Adding new contact
    void addPlace(double lat,double longi,double rad) {
        SQLiteDatabase db = this.getWritableDatabase();
 
        ContentValues values = new ContentValues();
        values.put(KEY_NAME, "dummy"); 
        values.put(KEY_LAT, ""+lat); 
        values.put(KEY_LONG, ""+longi);
        values.put(KEY_RAD, ""+rad);
 ...
 /*
    ...
    public List<location> getAllplaces() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setradius(cursor.getString(4));
    ...
    public int updateplaces(location contact) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        values.put(KEY_RAD, contact.radius);
        // updating row
    ...
    public void deleteplace(location contact) {
        SQLiteDatabase db = this.getWritableDatabase();
